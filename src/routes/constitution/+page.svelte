...
<div class="constitution">
    ...
    <p class="underscore">10 Starters</p>
    <ul>
        <li>QB</li>
        <li>RB</li>
        <li>RB</li>
    ...
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical .5PPR Scoring). The scoring system will never change without a supermajority league vote.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The 5 teams with the best regular season record, and the player with the highest points for that otherwise did not make the playoffs, will receive a playoff berth. The 2 teams that had the best regular season record will receive a bye week in the first round of the playoffs. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>No team may intentionally leave starting roster spots empty. Do not intentionally sandbag your team in order to give your opponent a win. Draft tanking is countered through use of Max Points-For for non-playoff teams.</p>

    <h2 class="sectionHeading" bind:this={six}>Section 6 Replacing Managers</h2>
    
    <h3 bind:this={sixOne}>6.1 Removing Managers</h3>
    <p>Short of continuously failing to set a valid lineup, or confirmed collusion, no manager can be removed against their will. Participation, through the league chat, trade offers, and the waiver wire, is strongly encouraged but absence is not grounds for removal.</p>
    ...
    <p>A supermajority vote is required in order to raise league dues. In the event that a manager is no longer financially comfortable with the buyin, finding a co-manager to split the cost is reccomended.</p>
